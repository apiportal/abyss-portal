...
@AbyssTableName(tableName = "api_group")
public class ApiGroupService extends AbstractService<UpdateResult> {
    private static final Logger LOGGER = LoggerFactory.getLogger(ApiGroupService.class);
    private static final String SQL_INSERT = "insert into api_group (organizationid, crudsubjectid, subjectid, name, description)\n" +
            "values (CAST(? AS uuid) ,CAST(? AS uuid) ,CAST(? AS uuid) ,? ,?)";
    private static final String SQL_DELETE = "update api_group\n" +
            "set\n" +
            "  deleted     = now()\n" +
            "  , isdeleted = true\n";
    ...
    private static final String SQL_SUBJECTID_IS = "subjectid = CAST(? AS uuid)\n";
    public static final String SQL_FIND_BY_SUBJECTID = SQL_SELECT + SQL_WHERE + SQL_SUBJECTID_IS;
    ...
    public ApiGroupService(Vertx vertx, AbyssJDBCService abyssJDBCService) {
        super(vertx, abyssJDBCService);
    }

    public ApiGroupService(Vertx vertx) {
        super(vertx);
    }
