...
@AbyssTableName(tableName = "api_category")
public class ApiCategoryService extends AbstractService<UpdateResult> {
    private static final Logger LOGGER = LoggerFactory.getLogger(ApiCategoryService.class);
    private static final String SQL_INSERT = "insert into api_category (organizationid, crudsubjectid, name, description)\n" +
            "values (CAST(? AS uuid) ,CAST(? AS uuid) ,? ,?)";
    private static final String SQL_DELETE = "update api_category\n" +
            "set\n" +
            "  deleted     = now()\n" +
            "  , isdeleted = true\n";
    private static final String SQL_SELECT = "select\n" +
            ...
            "from\n" +
            "api_category\n";
    private static final String SQL_UPDATE = "UPDATE api_category\n" +
            "SET\n" +
    ...
    public ApiCategoryService(Vertx vertx, AbyssJDBCService abyssJDBCService) {
        super(vertx, abyssJDBCService);
    }

    public ApiCategoryService(Vertx vertx) {
        super(vertx);
    }
