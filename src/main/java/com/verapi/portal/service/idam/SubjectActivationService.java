...
@AbyssTableName(tableName = "subject_activation")
public class SubjectActivationService extends AbstractService<UpdateResult> {
    private static final Logger LOGGER = LoggerFactory.getLogger(SubjectActivationService.class);
    ...
    private static final String SQL_CONDITION_NAME_LIKE = "lower(userdata) like lower(?)\n";
    ...
    public SubjectActivationService(Vertx vertx, AbyssJDBCService abyssJDBCService) {
        super(vertx, abyssJDBCService);
    }

    public SubjectActivationService(Vertx vertx) {
        super(vertx);
    }
