...
public class SubjectTypeService extends AbstractService<UpdateResult> {
    ...
    public SubjectTypeService(Vertx vertx, AbyssJDBCService abyssJDBCService) {
        super(vertx, abyssJDBCService);
    }

    public SubjectTypeService(Vertx vertx) {
        super(vertx);
    }
        ...
        return insertParamsObservable
                ...
                .flatMap(o -> {
                    ...
                    JsonArray insertParam = new JsonArray()
                            ...
                            .add(jsonObj.getString("typedescription"));
    ...
    public Single<CompositeResult> update(UUID uuid, JsonObject updateRecord) {
        JsonArray updateParams = new JsonArray()
                ...
                .add(updateRecord.getString("typename"))
                .add(updateRecord.getString("typedescription"))
                .add(uuid.toString());
