...
@AbyssTableName(tableName = "contract_state")
public class ContractStateService extends AbstractService<UpdateResult> {
    private static final Logger LOGGER = LoggerFactory.getLogger(ContractStateService.class);
    private static final String SQL_INSERT = "insert into contract_state (organizationid, crudsubjectid, name, description)\n" +
            "values (CAST(? AS uuid), CAST(? AS uuid), ?, ?)";
    private static final String SQL_DELETE = "update contract_state\n" +
            "set\n" +
            "  deleted     = now()\n" +
            "  , isdeleted = true\n";
    private static final String SQL_SELECT = "select\n" +
            ...
            "from\n" +
            "contract_state\n";
    private static final String SQL_UPDATE = "UPDATE contract_state\n" +
            "SET\n" +
    ...
    public ContractStateService(Vertx vertx, AbyssJDBCService abyssJDBCService) {
        super(vertx, abyssJDBCService);
    }

    public ContractStateService(Vertx vertx) {
        super(vertx);
    }
