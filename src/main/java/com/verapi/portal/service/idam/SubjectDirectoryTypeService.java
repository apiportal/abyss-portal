...
@AbyssTableName(tableName = "subject_directory_type")
public class SubjectDirectoryTypeService extends AbstractService<UpdateResult> {
    private static final Logger LOGGER = LoggerFactory.getLogger(SubjectDirectoryTypeService.class);
    ...
    public SubjectDirectoryTypeService(Vertx vertx, AbyssJDBCService abyssJDBCService) {
        super(vertx, abyssJDBCService);
    }

    public SubjectDirectoryTypeService(Vertx vertx) {
        super(vertx);
    }
    ...
    protected JsonArray prepareInsertParameters(JsonObject insertRecord) {
        return new JsonArray()
                ...
                .add(insertRecord.getString("typename"))
                .add(insertRecord.getString("description"))
                .add(insertRecord.getJsonObject("attributetemplate").encode())
