...
@AbyssTableName(tableName = "subject_organization")
public class SubjectOrganizationService extends AbstractService<UpdateResult> {
    private static final Logger LOGGER = LoggerFactory.getLogger(SubjectOrganizationService.class);
    ...
    public SubjectOrganizationService(Vertx vertx, AbyssJDBCService abyssJDBCService) {
        super(vertx, abyssJDBCService);
    }

    public SubjectOrganizationService(Vertx vertx) {
        super(vertx);
    }
    ...
    protected JsonArray prepareInsertParameters(JsonObject insertRecord) {
        return new JsonArray()
                ...
                .add(insertRecord.getString("organizationrefid"))
                .add(insertRecord.getBoolean("isowner"))
