...
public class ApiApiGroupService extends AbstractService<UpdateResult> {
    private static final Logger logger = LoggerFactory.getLogger(ApiApiGroupService.class);

    public ApiApiGroupService(Vertx vertx, AbyssJDBCService abyssJDBCService) {
        super(vertx, abyssJDBCService);
    }

    public ApiApiGroupService(Vertx vertx) {
        super(vertx);
    }
        ...
        return insertParamsObservable
                ...
                .flatMap(o -> {
                    ...
                    JsonArray insertParam = new JsonArray()
                            ...
                            .add(((Number) jsonObj.getValue("apigroupid")).longValue());
    ...
    public Single<CompositeResult> update(UUID uuid, JsonObject updateRecord) {
        JsonArray updateParams = new JsonArray()
                ...
                .add(((Number) updateRecord.getValue("apigroupid")).longValue())
                .add(uuid.toString());
