...
@AbyssTableName(tableName = "api_visibility_type")
public class ApiVisibilityTypeService extends AbstractService<UpdateResult> {
    private static final Logger logger = LoggerFactory.getLogger(ApiVisibilityTypeService.class);
    ...
    public ApiVisibilityTypeService(Vertx vertx, AbyssJDBCService abyssJDBCService) {
        super(vertx, abyssJDBCService);
    }

    public ApiVisibilityTypeService(Vertx vertx) {
        super(vertx);
    }
